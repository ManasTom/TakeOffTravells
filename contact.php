...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "contact@takeoff.com ,takeofftraveldesigner@gmail.com";
    ...
    if (mail($to, $subject, $email_body, $headers)) {
        ...
        echo '<script>alert("Thank you for your message. We will get back to you shortly."); window.location.href = "https://takeofftravel.in/contact";</script>';

    } else {
        // Redirect to index page and display error alert
        echo '<script>alert("Oops! Something went wrong. Please try again later."); window.location.href = "https://takeofftravel.in/contact";</script>';
    }
}
?>
