...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "takeofftraveldesigner@gmail.com, contact@takeoff.com "; // Change this to your email
    ...
    if (mail($to, $subject, $email_body, $headers)) {
        ...
        $responder_headers = "From: contact@takeoff.com"; // Change this to your sender email

        mail($email, $responder_subject, $responder_message, $responder_headers);

        // Display success message
        echo '<script>alert("Thank you for your custom package enquiry. We will get back to you shortly."); window.location.href = "https://takeofftravel.in/packages";</script>';
    } else {
        // Display error message
        echo '<script>alert("Oops! Something went wrong. Please try again later."); window.location.href = "https://takeofftravel.in/packages";</script>';
    }
}
?>
